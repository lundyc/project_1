...
/**
 * Normalize an annotations feature flag value from the environment.
 */
function annotations_normalize_env_flag($value): ?bool
{
...
function annotations_enabled(): bool
{
          ...
          $env = getenv('ANNOTATIONS_ENABLED');
          $cached = annotations_normalize_env_flag($env);
          if ($cached !== null) {
                    return $cached;
          }

          $config = require __DIR__ . '/../../config/config.php';
          $cached = isset($config['annotations']['enabled']) ? (bool)$config['annotations']['enabled'] : true;
