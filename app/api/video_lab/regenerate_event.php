...
$eventId = isset($eventId) ? (int)$eventId : 0;
...
try {
          $result = clip_regeneration_service_regenerate_event($matchId, $eventId, (int)($user['id'] ?? 0));
          api_success([
                    'clip' => [
                              'id' => $result['clip_id'],
          ...
          clip_regeneration_service_handle_client_error($e);
...
function clip_regeneration_service_handle_client_error(InvalidArgumentException $exception): void
{
          $mapping = [
                    'match_not_found' => 404,
                    'event_not_found' => 404,
                    'event_not_supported' => 422,
                    'clip_not_auto' => 422,
                    'event_seconds_invalid' => 422,
          ];
