...
awk '/INSERT INTO `matches`/,/;$/' "$SQL_FILE" | grep "^(3, " | sed 's/^(3, /(19, /' | sed 's/^/INSERT INTO `matches` (`id`, `club_id`, `season_id`, `competition_id`, `home_team_id`, `away_team_id`, `kickoff_at`, `match_video`, `venue`, `referee`, `attendance`, `status`, `notes`, `events_version`, `clips_version`, `derived_version`, `created_by`, `created_at`, `updated_at`) VALUES\n/' >> "$OUTPUT_FILE"
echo ";" >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
awk '/INSERT INTO `events`/,/;$/' "$SQL_FILE" | grep ", 3, " | sed 's/, 3, /, 19, /' | sed 's/),$/),/' >> "$OUTPUT_FILE"
sed -i '$ s/),$/);/' "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"

# Extract clips
echo "-- clips table" >> "$OUTPUT_FILE"
echo "INSERT INTO \`clips\` (\`id\`, \`match_id\`, \`event_id\`, \`start_second\`, \`end_second\`, \`source_video\`, \`video_path\`, \`status\`, \`created_by\`, \`created_at\`, \`updated_at\`) VALUES" >> "$OUTPUT_FILE"
awk '/INSERT INTO `clips`/,/;$/' "$SQL_FILE" | grep ", 3, " | sed 's/, 3, /, 19, /' | sed 's/),$/),/' >> "$OUTPUT_FILE"
sed -i '$ s/),$/);/' "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
awk '/INSERT INTO `clip_jobs`/,/;$/' "$SQL_FILE" | grep "\"match_id\": 3" | sed 's/"match_id": 3/"match_id": 19/' | sed 's/),$/),/' >> "$OUTPUT_FILE"
sed -i '$ s/),$/);/' "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
awk '/INSERT INTO `match_players`/,/;$/' "$SQL_FILE" | grep ", 3, " | sed 's/, 3, /, 19, /' | sed 's/),$/),/' >> "$OUTPUT_FILE"
sed -i '$ s/),$/);/' "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
awk '/INSERT INTO `match_formations`/,/;$/' "$SQL_FILE" | grep ", 3, " | sed 's/, 3, /, 19, /' | sed 's/),$/),/' >> "$OUTPUT_FILE"
sed -i '$ s/),$/);/' "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
awk '/INSERT INTO `match_periods`/,/;$/' "$SQL_FILE" | grep ", 3, " | sed 's/, 3, /, 19, /' | sed 's/),$/),/' >> "$OUTPUT_FILE"
sed -i '$ s/),$/);/' "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
awk '/INSERT INTO `match_videos`/,/;$/' "$SQL_FILE" | grep ", 3, " | sed 's/, 3, /, 19, /' | sed 's/),$/),/' >> "$OUTPUT_FILE"
sed -i '$ s/),$/);/' "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
awk '/INSERT INTO `derived_stats`/,/;$/' "$SQL_FILE" | grep ", 3, " | sed 's/, 3, /, 19, /' | sed 's/),$/),/' >> "$OUTPUT_FILE"
sed -i '$ s/),$/);/' "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
awk '/INSERT INTO `playlists`/,/;$/' "$SQL_FILE" | grep ", 3, " | sed 's/, 3, /, 19, /' | sed 's/),$/),/' >> "$OUTPUT_FILE"
sed -i '$ s/),$/);/' "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
awk '/INSERT INTO `match_locks`/,/;$/' "$SQL_FILE" | grep ", 3, " | sed 's/, 3, /, 19, /' | sed 's/),$/),/' >> "$OUTPUT_FILE"
sed -i '$ s/),$/);/' "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
